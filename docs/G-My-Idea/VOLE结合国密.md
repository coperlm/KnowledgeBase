...
核心：FAEST的安全性主要依赖于AES和SHA-3，而SM-FAEST安全性依赖于SM4和SM3

（AES -> SM4 , SHA-3 -> SM3）

## FAEST是什么

FAEST 是密码学中一种较新的后量子数字签名方案。目前，它是NIST后量子密码学标准化项目中“额外签名方案”（第四轮/第二阶段）的候选算法之一。

核心卖点：如果你信任 AES 是安全的，那么 FAEST 就是安全的。
